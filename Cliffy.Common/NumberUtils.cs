...
namespace Cliffy.Common
{
    ...
    public sealed class NumberUtils
    {
        ...
        /// <returns><see lang="true"/> if the supplied <paramref name="number"/> is an integer.</returns>
        ...
        /// </summary>
        /// <param name="number">The object to check.</param>
        /// <returns><see lang="true"/> if the supplied <paramref name="number"/> is a decimal number.</returns>
        ...
        /// </summary>
        /// <param name="number">The object to check.</param>
        /// <returns><c>true</c> if the specified object is of numeric type; otherwise, <c>false</c>.</returns>
        ...
        /// </summary>
        /// <param name="number">The object to check.</param>
        /// <returns><see lang="true"/> if the supplied <paramref name="number"/> can be converted to an integer.</returns>
